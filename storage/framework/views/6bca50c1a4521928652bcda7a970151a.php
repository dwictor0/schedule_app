...
<body>
    <form action="<?php echo e(route('edit_activity', ['nome' => $activity->nome])); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/html/projetos/lab2/schedule_app/resources/views/teste/edit.blade.php ENDPATH**/ ?>